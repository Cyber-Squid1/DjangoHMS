...
urlpatterns = [
    ...
    path('ViewAdmitRecord/<int:admitId>/',ViewAdmitRecord,name='ViewAdmitRecord'),
    path('viewAllAdmittedPatients/',ViewAllAdmittedPatients,name='ViewAllAdmittedPatients'),
